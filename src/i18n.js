    ...
    translation: {
        ...
        talks: [
          {
            id: 1,
            conference: 'TDC 2025',
            topic: 'Coordenação de trilha e palestra — temas de engenharia moderna',
            year: '2025',
            location: 'Brasil',
            speakers: ['Rafael'],
            international: false,
          ...
          {
            id: 2,
            conference: 'TDC Summit SP 2024',
            topic: 'Painel: Inteligência Artificial na Engenharia de Software',
            year: '2024',
            location: 'São Paulo, Brasil',
            speakers: ['Rafael', 'Larissa'],
            international: false,
          },
          {
            id: 3,
          ...
          {
            id: 4,
            conference: 'TestBash Spring',
            topic: 'Qualidade intrínseca e cultura de engenharia',
            year: '2023',
          ...
          },
          {
            ...
            topic: 'Lean digital transformation e qualidade',
            year: '2022',
            location: 'Potsdam, Alemanha',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 6,
            conference: 'TestBash',
            topic: 'Automação e qualidade de software',
            year: '2022',
          ...
          },
          {
            ...
            topic: 'Engenharia de qualidade avançada',
            year: '2022',
          ...
          },
          {
            ...
            topic: 'Agile engineering e transformação digital',
            year: '2021',
          ...
          },
          {
            ...
            topic: 'DevOps e entrega contínua de qualidade',
            year: '2021',
            location: 'Estados Unidos',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 10,
            conference: 'Starwest',
            topic: 'Estratégias de automação de testes',
            year: '2021',
            location: 'Estados Unidos',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 11,
            conference: 'TDC 2021',
            topic: 'Trilhas DevTest e Kanban',
            year: '2021',
            location: 'Brasil',
            speakers: ['Rafael'],
            international: false,
          ...
          {
            id: 12,
            conference: 'International PHP Conference',
            topic: 'Qualidade e automação em ambientes PHP',
            year: '2021',
            location: 'Europa',
            speakers: ['Larissa'],
            international: true,
          },
          {
            ...
            topic: 'Transformação ágil e DevOps',
            year: '2020',
            location: 'Brasil',
            speakers: ['Rafael'],
            international: false,
      ...
      writing: {
        ...
        featuredArticle: {
          ...
          excerpt:
            'Como cultivar uma cultura de qualidade intrínseca em times de desenvolvimento — além de processos e ferramentas, uma mudança de mentalidade que transforma equipes de dentro para fora.',
          authors: 'Rafael Navarro Cintra & Larissa Rosochansky',
          url: 'https://leaddev.com/software-quality/instilling-built-quality-mindset-dev-team',
          cta: 'Ler no LeadDev',
        },
        moreComing: 'Mais artigos em breve.',
        moreComingDetail: 'Acompanhe nosso trabalho no Medium e LinkedIn.',
    ...
    translation: {
        ...
        talks: [
          {
            id: 1,
            conference: 'TDC 2025',
            topic: 'Track coordinator and speaker — modern engineering topics',
            year: '2025',
            location: 'Brazil',
            speakers: ['Rafael'],
            international: false,
          },
          {
            id: 2,
            conference: 'TDC Summit SP 2024',
            topic: 'Panel: Artificial Intelligence in Software Engineering',
            year: '2024',
            location: 'São Paulo, Brazil',
            speakers: ['Rafael', 'Larissa'],
            international: false,
          ...
          },
          {
            id: 4,
            conference: 'TestBash Spring',
            topic: 'Built-in quality and engineering culture',
            year: '2023',
            location: 'UK / Online',
            speakers: ['Rafael', 'Larissa'],
            international: true,
          },
          {
            id: 5,
            conference: 'Agile Testing Days',
            topic: 'Lean digital transformation and quality',
            year: '2022',
          ...
          },
          {
            id: 6,
            conference: 'TestBash',
            topic: 'Software quality and automation',
            year: '2022',
          ...
          },
          {
            id: 7,
            conference: 'Ministry of Testing Masterclass',
            topic: 'Advanced quality engineering',
            year: '2022',
            location: 'Online / Global',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 8,
            conference: 'AgileTD USA',
            topic: 'Agile engineering and digital transformation',
            year: '2021',
          ...
          },
          {
            id: 9,
            conference: 'Agile+DevOps East',
            topic: 'DevOps and continuous quality delivery',
            year: '2021',
            location: 'United States',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 10,
            conference: 'Starwest',
            topic: 'Test automation strategies',
            year: '2021',
            location: 'United States',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 11,
            conference: 'TDC 2021',
            topic: 'DevTest and Kanban tracks',
            year: '2021',
            location: 'Brazil',
            speakers: ['Rafael'],
            international: false,
          },
          {
            id: 12,
            conference: 'International PHP Conference',
            topic: 'Quality and automation in PHP environments',
            year: '2021',
            location: 'Europe',
            speakers: ['Larissa'],
            international: true,
          },
          {
            id: 13,
            conference: 'Agile Trends',
            topic: 'Agile transformation and DevOps',
            year: '2020',
            location: 'Brazil',
            speakers: ['Rafael'],
            international: false,
      ...
      writing: {
        ...
        featuredArticle: {
          ...
          title: 'Instilling the Built-in Quality Mindset into a Dev Team',
          excerpt:
            'How to cultivate a culture of built-in quality in development teams — beyond processes and tools, a mindset shift that transforms teams from the inside out.',
          authors: 'Rafael Navarro Cintra & Larissa Rosochansky',
          url: 'https://leaddev.com/software-quality/instilling-built-quality-mindset-dev-team',
          cta: 'Read on LeadDev',
        },
        moreComing: 'More articles coming soon.',
        moreComingDetail: 'Follow our work on Medium and LinkedIn.',
        mediumCta: 'Medium · Rafael',
        mediumUrl: 'https://medium.com/@rafaelnc',
      },
      contact: {
